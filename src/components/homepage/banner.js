...
const Banner = () => {
  ...
  const [location, setLocation] = useState(() => (router.query.location ? router.query.location : ''));
  ...
  useEffect(() => {
    function updatelivecounter() {
      ...
      if (livecounter)
        livecounter.innerHTML = base_counter.toString().slice(0, 2) + ',' + base_counter.toString().slice(2) + ' LIVE';
      live_update_counter++;
              ...
              <div className="d-flex flex-column hero-section">
                ...
                <form onSubmit={handleSearch}>
                  <div className="search-job-w activeusers">
                    <div className="job-title1" id="jobtitle1">
                      ...
                      <input
                        ...
                        onFocus={() => {
                          document.getElementById('jobtitle2').style = 'display:block';
                        }}
                        onBlur={() => {
                          document.getElementById('jobtitle2').style = 'display:none';
                        }}
                      />
                    </div>
            ...
            <Col lg={6} md={8}>
              <div className="banner-iphone mb-2">
                <div className="home-iphone">
                  <img src="/assets/images/page.png" className="bannergif" />
                  <img src={'/assets/images/home-circle-img.png'} className="banner-bg-circle" alt="bg-circle" />
                </div>
              </div>
            </Col>
