    ...
    <div className="menu-wrap">
      <ul className="main-menu">
        <li className={router.pathname === '/timeline' ? 'active' : ''}>
          <Link href="/timeline">
            <a>
              <i className="icon-home_selected" />
              Home
            </a>
          </Link>
        </li>
        <li className="has-sub-menu">
          ...
          >
            <i className="icon-job_unselected" />
            My Jobs
          </a>
          <ul className="sub-menu d-none" id="jobs-dropdown">
            <li onClick={() => handleJobClick('APPLIED_JOB')}>
              <a>
                <span>Applied Jobs</span>
              </a>
            </li>
            <li onClick={() => handleJobClick('ALL_JOB')}>
              <a>
                <span>All Jobs</span>
              </a>
            </li>
            <li onClick={() => handleJobClick('POST_NEW_JOB')}>
              <a>
                <span>Post a new job</span>
              </a>
            </li>
            <li onClick={() => handleJobClick('CREATED_JOBS')}>
              <a>
        ...
        <li className={router.pathname === '/timeline/network' ? 'active' : ''}>
          ...
          <Link href="/timeline/network">
            <a>
              <i className="icon-network_selected" />
              Network
            </a>
          </Link>
        </li>
        ...
        <li className={router.pathname === '/chat' ? 'active' : ''} onClick={handleChatClick}>
          {/* <Link href=""> */}
          <a>
            <i className="icon-message_unselected" />
            Messages
          </a>
          {/* </Link> */}
        </li>
        ...
        <li className="has-sub-menu">
          ...
          >
            <i className="icon-legal_unselected" />
            Legal
          </a>
