...
const Type3 = ({jobDetails}) => {

  const { Image } = useQRCode();

  const downloadQR = (e) => {
    e.preventDefault();
    domtoimage.toBlob(document.getElementById('type-3-qr-code'))
    .then(function (blob) {
  ...
  const shareQr = () => {
    ...
    return (
         ...
         <>
          <div className='option-card-box option-card3 mb-0' id={'type-3-qr-code'}>
            ...
            <div className='option-card-body'>
              ...
              <div className='position-relative'>
                  ...
                  />
                  <img className='qr-img1 position-absolute' style={{top:"50%",left:"50%",transform:"translate(-50%,-50%)"}} height="30" src={"/assets/qr-pin.png"} alt="QrCode" />
                  </div>
