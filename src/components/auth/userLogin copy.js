              ...
              <div className="form_box px-3">
                <div className="section-header">
                  ...
                  <p className="text mb-0">
                    Please login via credentials or continue with social
                    account.
                  </p>
                </div>
                <Formik
                      ...
                      <form>
                        <div className="form-group">
                          <input
                            ...
                            placeholder="Mobile number or Email I'd"
                            required
                        ...
                        <button
                          type="button"
                          className="d-flex forgot_pass ms-auto fs-6"
                          onClick={onClick}
                        >
